...
export default async function handler(
  ...
  try {
    ...
    // Devolver TODOS los campos del objeto
    res.status(200).json({
      success: true,
      refCode,
      complete_property_object: property,
      // Extraer campos que probablemente contienen info de comprador/reserva
      key_fields_analysis: {
        producer: property.producer,
        internal_data_keys: Object.keys(property.internal_data || {}),
        transaction_data: property.transaction_data,
        buyers: property.buyers,
        selling_agent: property.selling_agent,
